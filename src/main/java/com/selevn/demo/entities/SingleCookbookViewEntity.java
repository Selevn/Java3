...
@Entity
@Table(name = "single_cookbook_view", schema = "public", catalog = "cookbook")
public class SingleCookbookViewEntity {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        SingleCookbookViewEntity that = (SingleCookbookViewEntity) o;
